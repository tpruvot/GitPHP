 ...
 */
class GitPHP_CommitLoad_RawTest extends PHPUnit_Framework_TestCase
{
	public function testLoad()
	{
		$objectdata = "tree 0cbcbafede205ab07ca19e22663661cb8c8bf2aa\n" .
		...
		$loadermock->expects($this->once())->method('GetObject')->with($this->equalTo('1234567890abcdef1234567890ABCDEF12345678'))->will($this->returnValue($objectdata));
		...
		$strategy = new GitPHP_CommitLoad_Raw($loadermock, $this->getMock('GitPHP_GitExe'));
		$commitdata = $strategy->Load($commitmock);

		$this->assertCount(11, $commitdata);

		$this->assertNull($commitdata[0]);
