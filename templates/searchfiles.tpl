  ...
  {foreach from=$results item=result key=path}
    <tr class="{cycle values="light,dark"}">
      ...
      {if $resultobject instanceof GitPHP_Tree}
	      <td>
		  <a href="{$SCRIPT_NAME}?p={$project->GetProject('f')}&amp;a=tree&amp;h={$resultobject->GetHash()}&amp;hb={$commit->GetHash()}&amp;f={$path|escape:'url'}" class="list"><strong>{$path}</strong></a>
	      </td>
	      <td class="link">
		  <a href="{$SCRIPT_NAME}?p={$project->GetProject('f')}&amp;a=tree&amp;h={$resultobject->GetHash()}&amp;hb={$commit->GetHash()}&amp;f={$path|escape:'url'}">{t}tree{/t}</a>
	      </td>
      {else}
	      <td>
		  <a href="{$SCRIPT_NAME}?p={$project->GetProject('f')}&amp;a=blob&amp;h={$result.object->GetHash()}&amp;hb={$commit->GetHash()}&amp;f={$path|escape:'url'}" class="list"><strong>{$path|highlight:$search}</strong></a>
	      ...
	      <td class="link">
		  <a href="{$SCRIPT_NAME}?p={$project->GetProject('f')}&amp;a=blob&amp;h={$resultobject->GetHash()}&amp;hb={$commit->GetHash()}&amp;f={$path|escape:'url'}">{t}blob{/t}</a> | <a href="{$SCRIPT_NAME}?p={$project->GetProject('f')}&amp;a=history&amp;h={$commit->GetHash()}&amp;f={$path|escape:'url'}">{t}history{/t}</a>
	      </td>
      {/if}
    </tr>
  {/foreach}
