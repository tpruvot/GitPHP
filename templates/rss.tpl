...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/">
  <channel>
    ...
    <link>{geturl escape=true fullurl=true project=$project}</link>
    ...
    {foreach from=$log item=logitem}
      <item>
        ...
        <guid isPermaLink="true">{geturl escape=true fullurl=true project=$project action=commit hash=$logitem}</guid>
        <link>{geturl escape=true fullurl=true project=$project action=commit hash=$logitem}</link>
